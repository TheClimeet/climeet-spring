    ...
    public Operation customize(Operation operation, HandlerMethod handlerMethod) {
        ...
        if (swaggerApiError != null) {
            ...
            for (ErrorStatus errorStatus : swaggerApiError.value()) {
                ...
                List<Map<String, Object>> errorDetails = errorDetailsMap.getOrDefault(statusCode, new ArrayList<>());
            ...
            errorDetailsMap.forEach((statusCode, errorList) -> {
                ...
                Content content = new Content()
                    .addMediaType(org.springframework.http.MediaType.APPLICATION_JSON_VALUE, new MediaType().schema(errorSchema));
